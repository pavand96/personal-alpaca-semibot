...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "adaptive_semis_allocator": {
        ...
        "trailing_stop_pct_bull": 22.0,
        "trailing_wide_min_profit_pct": 8.0,
        "hard_stop_pct": 12.0,
        ...
        "slow_momentum_weight": 1.2,
        "fast_momentum_weight": 2.0,
        "short_momentum_weight": 0.8,
        "score_proportional_sizing": True,
        "bull_exposure_pct": 0.80,
        "bull_max_symbols": 5,
        "rebalance_days_bull": 7,
        "bull_drawdown_cap_pct": 12.0,
        ...
        "rebound_trigger_drawdown_pct": -8.0,
        "rebound_fast_lookback_days": 5,
        "rebound_min_sector_fast_return_pct": 2.0,
        "rebound_min_market_fast_return_pct": -0.5,
        "rebound_breadth_sma_days": 5,
        "rebound_min_breadth_pct": 0.35,
        "rebound_symbol_lookback_days": 3,
        "rebound_min_symbol_return_pct": 2.0,
        "rebound_exposure_pct": 0.55,
        "rebound_max_symbols": 5,
        "rebound_rebalance_days": 2,
...
def validate_config(config: dict[str, Any]) -> None:
    ...
    for key in (
        ...
        "trailing_stop_pct",
        "hard_stop_pct",
        "rebound_fast_lookback_days",
        "rebound_breadth_sma_days",
        "rebound_symbol_lookback_days",
        "rebound_exposure_pct",
        "rebound_max_symbols",
        "rebound_rebalance_days",
    ):
